...
public class SoccerNewsRepository {
    private static final String REMOTE_API_URL = "https://douglasdr7.github.io/Soccer-news-API/";
    ...
    //garante uma instância única dos atributos relacionados ao Retrofit e Room.
    private SoccerNewsRepository() {
        ...
        localDb = Room.databaseBuilder(me.dio.soccernews.App.getInstance(), SoccerNewsDb.class, LOCAL_DB_NAME).build();
    }
